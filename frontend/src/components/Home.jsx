  ...
  return (
    <div className="welcome-splash">
      <div className="welcome-content">
        <h1>WELCOME TO</h1>
        <h1 className="welcome-title">AGRI<span> TECH</span> 3<span>.</span>0</h1>
      </div>
    </div>
  );
};
        ...
        <div onClick={handleFlowerClick}>
            ...
            <div id="home" className='homepage-container'>
                ...
                <div className="home-container">
                    <h1>AGRI<span> TECH</span> 3<span>.</span>0</h1>
                    <p>An Intra-college, 24 hours Hackathon by the Department of Agricultural Engineering at Kongunadu college of Engineering and Technology. Agritech 3.0 brings technology and agriculture together, empowering innovators to revolutionize farming with AI, IoT, and smart solutions. Join us to cultivate ideas and drive the future of agritech!</p>
                    <button className="button" onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLScNYG7dmK_k1QLV5G2nhs3oUZlzXUcvSidIxrdl6mxjZzOWDQ/viewform?usp=header', '_blank')}></button>
                </div>
            </div>       
